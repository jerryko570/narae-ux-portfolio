  ...
  return (
    <div className='relative'>
      <Section className='w-full bg-orange-500'>
        ...
        {/* 타이틀 */}
        <div className='pt-8 whitespace-pre-line text-white'>
          <Text as='display' className='break-keep'>
            {title}
          </Text>
          <Text as='h5' className='pt-8'>
            {description}
          </Text>
        </div>

        {/* 메타 정보 */}
        <div className='mt-32 flex w-fit gap-16 border-t border-white/20 pt-8 text-white'>
